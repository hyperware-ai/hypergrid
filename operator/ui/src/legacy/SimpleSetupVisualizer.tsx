...
//            const subEntryLabelForMint = "grid-beta-wallet";
...
//            const signersNoteKey = "~grid-beta-signers";
...
//        const operatorTba = onboardingData?.checks?.operatorTba as ViemAddress | undefined;
//        const operatorTbaFullName = `grid-beta-wallet.${nodeName || 'unknown'}`;
//        const signersNoteFullNameToHash = `~grid-beta-signers.${operatorTbaFullName}`;
...
//            const accessListNoteKey = "~access-list";
...
//            </div>
//            <div>  │</div>
//            <div>  ├─ Operator Sub-Entry (grid-beta-wallet.{nodeName || '(Node?)'})</div>
...
//                            <div>  │  │</div>
//                            <div>  │  ├─ Signers Note (~grid-beta-signers)</div>
...
//                            <div>  │  │</div>
//                            <div>  │  └─ Access List Note (~grid-beta-access-list)</div>
