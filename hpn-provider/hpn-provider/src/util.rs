...
pub async fn get_logs_for_tx(
    tx_hash_str: &String,
    state: &super::HpnProviderState, // Use super:: to refer to HpnProviderState from lib.rs
...
pub async fn validate_transaction_payment(
    ...
    state: &mut super::HpnProviderState, // Now mutable
    ...
    let full_name_for_tba_lookup = format!("hpn-beta-wallet.{}", source_node_id);
