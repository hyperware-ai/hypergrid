...
import { RegisteredProvider } from '../types/hpn_provider';
...
const ProviderInfoDisplay: React.FC<ProviderInfoDisplayProps> = ({ provider }) => {
  ...
  const handleCopyProviderMetadata = async () => {
    const hnsName = (provider.provider_name.trim() || "[ProviderName]") + ".hpn-beta.hypr";
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={hnsNameStyle}>{(provider.provider_name.trim() || "[ProviderName]") + ".hpn-beta.hypr"}</div>
