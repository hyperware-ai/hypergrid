...
import { searchIndexedProvidersApi } from "../utils/api";
...
const ProviderSearch: React.FC = () => {
  ...
  const [searchResults, setSearchResults] = useState<IndexedProvider[]>([]);
  ...
  const executeSearch = async () => {
    ...
    try {
      const results = await searchIndexedProvidersApi(searchTerm.toLowerCase());
